            ...
            <li class=" active treeview menu-open">
              <a href="#">
               ...
               <ul class="treeview-menu">
                 ...
                 <li class="active"><a href="javascript:void(0)" onclick=to("pInfo")><i class="fa fa-circle-o"></i> 小&nbsp;&nbsp;学</a></li>
...
<!-- 主体内容部分 -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <form action="${pageContext.request.contextPath}/searchAllPrimarySchoolByName" method="GET">
          ...
          <ul>
            <c:forEach items="${pInfo}" var="P">
              <li class="col-md-6" style="float: left;">
                <div class="box box-default">
                  <div class="box-header with-border">
                    <a class="box-title" href="javascript:void(0)" onclick=toWithId("pInfoDescription","${P.PSId}")>${P.PSName}</a>
                  ...
                  <div class="box-body">
                    <p style="display: none" class="address">${P.PSAddress}</p>
                    <p>${P.PSDescription}</p>
                  </div>
                  <div style="text-align: right;">
                    <button class="btn btn-primary" style="margin-right: 30px; margin-bottom:8px;" onclick=toWithId("pInfoDescription","${P.PSId}")>
                      查看
                    </button>
                  </div>
                </div>
      ...
      if(e!=false){
        $.ajax({
          ...
          success: function (result) {
            if (result == "success") {
              $("#modal-message").html("提交成功！代管理员审核。");
