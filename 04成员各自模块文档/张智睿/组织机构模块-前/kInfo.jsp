            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="active treeview menu-open">
                    ...
                    <ul class="treeview-menu">
                        <li class="active"><a href="javascript:void(0)" onclick=to("kInfo")><i
                                class="fa fa-circle-o"></i> 幼稚园</a></li>
                        ...
                        <li class="col-md-6" style="float: left;">
                            <div class="box box-default">
                                <div class="box-header with-border">
                                    <a class="box-title" href="javascript:void(0)"
                                       onclick=toWithId("kInfoDescription","${k.KId}")>${k.KName}</a>
                                ...
                                <div class="box-body">
                                    <p style="display: none" class="address">${k.KAddress}</p>
                                    <p>${k.KDescription}</p>
                                </div>
                                <div style="text-align: right;">
                                    <button class="btn btn-primary" style="margin-right: 30px; margin-bottom:8px;"
                                            onclick=toWithId("kInfoDescription","${k.KId}")>
                                        查看
                                    </button>
                                </div>
                            </div>
