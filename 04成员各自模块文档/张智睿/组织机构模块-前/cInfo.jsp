...
<div class="wrapper">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview menu-open">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="javascript:void(0)" onclick=to("cInfo")><i class="fa fa-circle-o"></i> 大&nbsp;&nbsp;学</a></li>
          </ul>
        </li>
       <li class="treeview" >
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <form action="${pageContext.request.contextPath}/searchAllCollegeByName" method="GET">
            ...
            <li class="col-md-6" style="float: left;">
              <div class="box box-default">
                <div class="box-header with-border">
                  <a class="box-title" href="javascript:void(0)" onclick=toWithId("cInfoDescription","${C.CId}")>${C.CName}</a>
                ...
                <div class="box-body">
                  <p style="display: none" class="address">${C.CAddress}</p>
                  <p>${C.CDescription}</p>
                </div>
                <div style="text-align: right;">
                  <button class="btn btn-primary" style="margin-right: 30px; margin-bottom:8px;" onclick=toWithId("cInfoDescription","${C.CId}")>
                    查看
                  </button>
                </div>
              </div>
