            ...
            <li class=" active treeview">
              <a href="#">
               ...
               <ul class=" treeview-menu menu-open">
                 ...
                 <li class="active"><a href="javascript:void(0)" onclick=to("mInfo")><i class="fa fa-circle-o"></i> 初&nbsp;&nbsp;中</a></li>
...
<!-- 主体内容部分 -->
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <form action="${pageContext.request.contextPath}/searchAllMiddleSchoolByName" method="GET">
                ...
                <li class="col-md-6" style="float: left;">
                  <div class="box box-default">
                    <div class="box-header with-border">
                      <a class="box-title" href="javascript:void(0)" onclick=toWithId("mInfoDescription","${M.MSId}")>${M.MSName}</a>
                    ...
                    <div class="box-body">
                      <p style="display: none" class="address">${M.MSAddress}</p>
                      <p>${M.MSDescription}</p>
                    </div>
                    <div style="text-align: right;">
                      <button class="btn btn-primary" style="margin-right: 30px; margin-bottom:8px;" onclick=toWithId("mInfoDescription","${M.MSId}")>
                        查看
                      </button>
                    </div>
                  </div>
