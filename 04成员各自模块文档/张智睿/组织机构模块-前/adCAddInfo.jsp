      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active  treeview menu-open">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="javascript:void(0)" onclick=to("adCInfo")><i class="fa fa-circle-o"></i> 大&nbsp;&nbsp;学</a></li>
          </ul>
        </li>
      <li class=" treeview">
                        <a href="#">
              ...
              <div class="box-body " id="inputchoose" >
                <form class="form-horizontal" id="add_form">
                  <div class="form-group">
                    ...
                    <div class="col-sm-3">
                      <input type="text" class="form-control" name="CName" id="1" placeholder="请输入名称" >
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="2" class="col-sm-2 control-label">地址</label>
                    <div class="col-sm-3">
                      <input type="text" class="form-control" name="CAddress" id="2" placeholder="请输入地址" >
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="3" class="col-sm-2 control-label">教职工数量</label>
                    <div class="col-sm-3">
                      <input type="text" class="form-control" name="CStuffs" id="3" placeholder="请输入教职工" >
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="4" class="col-sm-2 control-label">专职老师数量</label>
                    <div class="col-sm-3">
                      <input type="text" class="form-control" name="CTeachers" id="4" placeholder="请输入专职老师数量" >
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="5" class="col-sm-2 control-label">学生总人数</label>
                    <div class="col-sm-3">
                      <input type="text" class="form-control" name="CCapacity" id="5" placeholder="请输入学生总人数" >
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="6" class="col-sm-2 control-label">年招生人数</label>
                    <div class="col-sm-3">
                      <input type="text" class="form-control" name="CCapacityYears" id="6" placeholder="请输入年招生人数" >
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="7" class="col-sm-2 control-label">机构描述</label>
                    <div class="col-sm-5">
                      <textarea class="form-control" name="CDescription" rows="4" placeholder="请输入相关描述" style="resize: none;" form="add_form" id="7"></textarea>
                    </div>
                  </div>
                  <!-- 隐藏 -->
                  ...
                  <div class="form-group" >
                    ...
                    <div class="col-sm-3">
                      <input type="text" class="form-control" id="8" placeholder="Password" value="0" name="CPointX" >
                    </div>
                  </div>
                  <div class="form-group" >
                    <label for="9" class="col-sm-2 control-label">点坐标Y</label>
                    <div class="col-sm-3">
                      <input type="text" class="form-control" id="9" placeholder="Password" value="0" name="CPointY">
                    </div>
                  </div>
                  <!-- 隐藏结束 -->
                  <div class="form-group">
                    <button type="button" class="btn btn-info col-xs-offset-2" style="margin-top: 20px;" id="submitBtn">
                      ...
                      提交</button>
                    <button type="button" class="btn btn-info col-xs-offset-1" style="margin-top: 20px;" onclick=to("adCInfo")>
                      <!-- <a href="adKInfo.html"></a> -->
                      返回</button>
                  </div>
...
<script>
  ...
  $('#submitBtn').click(function () {
    ...
    $.ajax({
      url:"${pageContext.request.contextPath}/addCollege",
      type:"POST",
      data:formData,
      processData:false,
      contentType:false,
      success:function (result) {
        if (result == "success"){
          ...
          window.location.href = "${pageContext.request.contextPath}/to/adCInfo";
        }else{
